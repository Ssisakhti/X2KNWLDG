...
The mockups are drawn: [`docs/mockups/T-255/`](mockups/T-255/SPEC.md), 20 captures over two
compositions and an honest-states sheet, awaiting the user's approval.
