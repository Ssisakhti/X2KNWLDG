...
```bash
.venv/bin/python -m pytest -q               # expect: 1645 passed, 0 failed, 36 subtests (plus new tests)
...
/tmp/bare/bin/python -m pytest -q           # expect: 1436 passed, 5 skipped, 36 subtests
```
